from collective.classschedule.content.academic_calendar import IAcademicCalendar
...
class AcademicCalendarIntegrationTest(unittest.TestCase):
    ...
    def test_ct_academic_calendar_factory(self):
        ...
        self.assertTrue(
            ...
            f"IAcademicCalendar not provided by {obj}!",
        )
    ...
    def test_ct_academic_calendar_adding(self):
        ...
        self.assertTrue(
            IAcademicCalendar.providedBy(obj),
            f"IAcademicCalendar not provided by {obj.id}!",
        )
