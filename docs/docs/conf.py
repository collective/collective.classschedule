...
# Class Schedule build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/classschedule/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/classschedule",
    ...
    "repository_url": "https://github.com/collective/classschedule",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/classschedule/edit/main/docs/",
# }
...
ogp_site_name = "Class Schedule Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Class ScheduleDocumentation"
...
latex_documents = [
    (
        "index",
        "Class ScheduleDocumentation.tex",
        "Class Schedule Documentation",
